package com.example.java3.week3.aop;


import com.example.java3.week3.aop.advice.*;
import com.example.java3.week3.aop.interceptor.*;
        ...
        for(Method aspectMethod: aspectClass.getDeclaredMethods()) {
            for(Annotation ano: aspectMethod.getDeclaredAnnotations()) {
                ...
                if(ano.annotationType() == Before.class) {
                    ...
                    methodInterceptor = new AfterExceptionMethodInterceptor(aspectObj, aspectMethod);

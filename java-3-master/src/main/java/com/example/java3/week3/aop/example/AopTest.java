...
import com.example.java3.week3.aop.advice.*;
...
public class AopTest {
    public static void main(String[] args) throws NoSuchMethodException {
        ...
        ss.get();
        Class<?> returnType = ss.getClass().getMethod("get").getReturnType();
        StudentAspect st = new StudentAspect();
        st.afterReturn(returnType);
...
class StudentAspect {
    ...
    @AfterReturn
    public void afterReturn(Class<?> returnType){
        if (returnType != void.class) System.out.println("AfterReturn ========");
    }
